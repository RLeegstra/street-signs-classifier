...
def streetsigns_model(nr_classes):
    # model for streetsigns classification


    my_input = Input(shape=(60,60,3)) # with varying image shapes, try to compute the average shape (in our case = approx 60x60)
